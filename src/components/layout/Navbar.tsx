...
export default function Navbar() {
  ...
  return (
    <nav className="sticky top-0 z-50 bg-slate-900/70 backdrop-blur-xl [mask-image:linear-gradient(to_bottom,black_85%,transparent)]">
      ...
      <motion.div
        ...
        className="h-[2px] bg-gradient-to-r from-slate-500 to-white origin-left"
      />
    </nav>
  );
}
